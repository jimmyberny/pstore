...
<html lang="es">
    <head>
        ...
        <script id="categoria-tmpl" type="text/template">
            <table class="table">
                <thead>
                    <tr>
                        <td>Nombre</td>
                ...
                <tr id="fila-categoria-{{id}}">
                    <td>{{nombre}}</td>
                    <td>
                        <button type="button" onclick="mostrarCategoria('{{id}}')" class="btn btn-default btn-xs">
                            <span class="glyphicon glyphicon-edit"></span>
                        </button>
                        <button type="button" onclick="eliminarCategoria('{{id}}')" class="btn btn-default btn-xs">
